        ...
        <Row gutter={50}>
          ...
          <Col>
            <Form
              ...
              >
                <Form.Item
                  label={"Velocity  Modulation of R1 Amount"}
                >
                  <Donut
                      diameter={50}
                      step={1}
                ...
                <Form.Item
                  label={"Velocity Modulation of R4 Amount"}
                >
                  <Donut
                      diameter={50}
                      step={1}
                ...
                <Form.Item
                  label={"Velocity Off Modulation of R4 Amount"}
                >
                  <Donut
                      diameter={50}
                      step={1}
                ...
                <Form.Item
                  label={"Key Modulation of R2 and R4 Amount"}
                >
                  <Donut
                      diameter={50}
                      step={1}
                ...
                <Form.Item
                  label={"Velocity Modulation of Enveloper Amount"}
                >
                  <Donut
                      diameter={50}
                      step={1}
