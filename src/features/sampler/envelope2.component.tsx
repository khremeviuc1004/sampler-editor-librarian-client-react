        ...
        <Row gutter={50}>
          ...
          <Col>
            <Form
              ...
              >
                <Form.Item
                  label={"Velocity  Modulation of R1"}
                >
                  <Donut
                      diameter={50}
                      step={1}
                      ...
                      onValueChange={(value: number | null) => props.handleChange(24, value, ["envelope2", "velocityModulationOfRate1"], props.data)} />
                </Form.Item>
                <Form.Item
                  label={"Velocity Modulation of R4"}
                >
                  <Donut
                      diameter={50}
                      step={1}
                      ...
                      onValueChange={(value: number | null) => props.handleChange(25, value, ["envelope2", "velocityModulationOfRate4"], props.data)} />
                </Form.Item>
                <Form.Item
                  label={"Velocity Off Modulation of R4"}
                >
                  <Donut
                      diameter={50}
                      step={1}
                      ...
                      onValueChange={(value: number | null) => props.handleChange(26, value, ["envelope2", "velocityOffModulationOfRate4"], props.data)} />
                </Form.Item>
                <Form.Item
                  label={"Key Modulation of R2 and R4"}
                >
                  <Donut
                      diameter={50}
                      step={1}
                      ...
                      onValueChange={(value: number | null) => props.handleChange(27, value, ["envelope2", "keyModulationOfRate2AndRate4"], props.data)} />
                </Form.Item>
                <Form.Item
                  label={"Velocity Modulation of Enveloper"}
                >
                  <Donut
                      diameter={50}
                      step={1}
                      ...
                      onValueChange={(value: number | null) => props.handleChange(28, value, ["envelope2", "velocityModulationOfEnvelope"], props.data)} />
                </Form.Item>
            </Form>
          </Col>
          <Col>
