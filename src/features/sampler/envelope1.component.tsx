    ...
    <>
      <Row gutter={50}>
        ...
        <Col>
          ...
          >
            <Form.Item
              label={"Velocity  Modulation of Attack"}
            >
              <Donut
                diameter={50}
                step={1}
            ...
            <Form.Item
              label={"Velocity Modulation of Release"}
            >
              <Donut
                diameter={50}
                step={1}
            ...
            <Form.Item
              label={"Velocity Off Modulation of Release"}
            >
              <Donut
                diameter={50}
                step={1}
            ...
            <Form.Item
              label={"Key Modulation of Decay and Release"}
